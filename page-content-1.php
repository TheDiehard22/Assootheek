<?php
/*
Template Name: verzekeringen pagina
*/
get_header(); ?>
...
<section class="content container">
  ...
  <div class="row">
    <div class="col-xs-12">
      <img class="content__hypotheken" src="<?php echo get_template_directory_uri(); ?>/src/img/logos_verzekeringen.jpg" alt="verzekeringen">
    </div>
  </div>
